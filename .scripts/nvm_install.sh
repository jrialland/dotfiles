...
#jr slightly modified version of the nvm installation script, for an hostile environnement where the dns for raw.githubusercontent.com is blocked !

export GITHUB_USER_CONTENT=151.101.52.133
...
nvm_source() {
  ...
  if [ "_$NVM_METHOD" = "_script-nvm-exec" ]; then
    NVM_SOURCE_URL="https://${GITHUB_USER_CONTENT}/nvm-sh/nvm/$(nvm_latest_version)/nvm-exec"
  elif [ "_$NVM_METHOD" = "_script-nvm-bash-completion" ]; then
    NVM_SOURCE_URL="https://${GITHUB_USER_CONTENT}/nvm-sh/nvm/$(nvm_latest_version)/bash_completion"
  elif [ -z "$NVM_SOURCE_URL" ]; then
    if [ "_$NVM_METHOD" = "_script" ]; then
      NVM_SOURCE_URL="https://${GITHUB_USER_CONTENT}/nvm-sh/nvm/$(nvm_latest_version)/nvm.sh"
